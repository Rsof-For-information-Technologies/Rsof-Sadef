...
{
    /// <inheritdoc />
    public partial class AddedTranslationTable2 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(
                name: "MaintenanceRequestTranslations");
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MaintenanceRequestTranslations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MaintenanceRequestTranslations_MaintenanceRequests_MaintenanceRequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceRequestTranslations_MaintenanceRequestId",
                table: "MaintenanceRequestTranslations",
