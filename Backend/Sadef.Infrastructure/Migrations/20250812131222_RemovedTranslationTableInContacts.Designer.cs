...
namespace Sadef.Infrastructure.Migrations
{
    ...
    [Migration("20250812131222_RemovedTranslationTableInContacts")]
    partial class RemovedTranslationTableInContacts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sadef.Domain.ContactEntity.ContactTranslation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ContactTranslations", (string)null);
                });
            ...
            modelBuilder.Entity("Sadef.Domain.ContactEntity.ContactTranslation", b =>
                {
                    b.HasOne("Sadef.Domain.ContactEntity.Contact", "Contact")
                        .WithMany()
